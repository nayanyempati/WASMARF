...
import { ScrollbarGeometry, ScrollbarPosition } from '@opencops/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector  : '[opencopsScrollbar]',
    exportAs  : 'opencopsScrollbar',
    standalone: true,
})
export class OpencopsScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_opencopsScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() opencopsScrollbar: boolean = true;
    @Input() opencopsScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'opencopsScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.opencopsScrollbar = coerceBooleanProperty(changes.opencopsScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.opencopsScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'opencopsScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.opencopsScrollbarOptions.currentValue);
