...
@Component({
    selector       : 'opencops-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : opencopsAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone     : true,
    imports        : [NgClass, MatTooltipModule, NgIf, MatIconModule, NgFor, OpencopsVerticalNavigationBasicItemComponent, forwardRef(() => OpencopsVerticalNavigationCollapsableItemComponent), OpencopsVerticalNavigationDividerItemComponent, OpencopsVerticalNavigationGroupItemComponent, OpencopsVerticalNavigationSpacerItemComponent],
})
export class OpencopsVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'opencops-vertical-navigation-item-collapsed': this.isCollapsed,
            'opencops-vertical-navigation-item-expanded' : this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void
    {
        ...
        this._opencopsVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._opencopsVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._opencopsVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._opencopsVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _isChildrenOf(parent: OpencopsNavigationItem, item: OpencopsNavigationItem): boolean
    {
