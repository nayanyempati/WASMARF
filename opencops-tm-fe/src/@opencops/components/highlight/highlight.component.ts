...
import { OpencopsHighlightService } from '@opencops/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[opencops-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'opencopsHighlight',
    standalone     : true,
    imports        : [NgClass],
})
export class OpencopsHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _opencopsHighlightService: OpencopsHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._opencopsHighlightService.highlight(this.code, this.lang));
