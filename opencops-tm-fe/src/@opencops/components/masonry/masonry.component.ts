...
@Component({
    selector     : 'opencops-masonry',
    templateUrl  : './masonry.component.html',
    encapsulation: ViewEncapsulation.None,
    animations   : opencopsAnimations,
    exportAs     : 'opencopsMasonry',
    standalone   : true,
    imports      : [NgTemplateOutlet],
})
export class OpencopsMasonryComponent implements OnChanges, AfterViewInit
{
     ...
     * Constructor
     */
    constructor(private _opencopsMediaWatcherService: OpencopsMediaWatcherService)
    {
    }
