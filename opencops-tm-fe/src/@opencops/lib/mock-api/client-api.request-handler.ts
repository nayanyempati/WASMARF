...
import { OpencopsMockApiReplyCallback } from './client-api.types';

export class OpencopsMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: OpencopsMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: OpencopsMockApiReplyCallback): void
    {
        // Store the reply
