...
import { OpencopsConfig, OpencopsConfigService } from '@opencops/services/config';
...
import { OPENCOPS_VERSION } from '@opencops/version';
...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _opencopsPlatformService: OpencopsPlatformService,
    )
    {
    }
    ...
    ngOnInit(): void
    {
        ...
        combineLatest([
            ...
            this._opencopsMediaWatcherService.onMediaQueryChange$(['(prefers-color-scheme: dark)', '(prefers-color-scheme: light)']),
        ]).pipe(
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'opencops-version', OPENCOPS_VERSION);

        // Set the OS name
        this._renderer2.addClass(this._document.body, this._opencopsPlatformService.osName);
    }
