...
@Component({
    ...
    standalone   : true,
    imports      : [OpencopsLoadingBarComponent, OpencopsVerticalNavigationComponent, UserComponent, MatButtonModule, MatIconModule, LanguagesComponent, OpencopsFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, NotificationsComponent, NgIf, RouterOutlet, QuickChatComponent],
})
