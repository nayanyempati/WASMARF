...
@Component({
    ...
    standalone   : true,
    imports      : [OpencopsLoadingBarComponent, OpencopsVerticalNavigationComponent, NotificationsComponent, UserComponent, NgIf, MatIconModule, MatButtonModule, LanguagesComponent, OpencopsFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, RouterOutlet, QuickChatComponent],
})
