...
import { OpencopsMockApiUtils } from '@opencops/lib/mock-api/client-api.utils';
import { notifications as notificationsData } from 'app/client-api/common/notifications/data';
    ...
    registerHandlers(): void
    {
        ...
        this._opencopsMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                // Generate a new GUID
                newNotification.id = OpencopsMockApiUtils.guid();
